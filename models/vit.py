...
class Encoder(nn.Module):
    ...
    def __init__(self, embedding_dim: int, n_heads: int, n_layers: int) -> None:
        super().__init__()
        self.embedding_dim: int = embedding_dim
...
class Decoder(nn.Module):
    ...
    def __init__(
        self, n_input_days: int, embedding_dim: int, patch_size: int, out_features: int,
    ) -> None:
        super().__init__()
...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = Encoder(
            embedding_dim=embedding_dim, n_heads=n_heads, n_layers=n_transformer_layers
        )
