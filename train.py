    ...
    # TODO: optimize
        ...
        if (checkpoint_path := diffusion_config.from_checkpoint) is not None:
            ...
            net: UNetDenoiser = UNetDenoiser(
                ...
                target_H=precip_encoder.expected_H, target_W=precip_encoder.expected_W,
                n_scaling_blocks=diffusion_config.n_scaling_blocks,
                n_mid_blocks=diffusion_config.n_mid_blocks,
                scale_factor=diffusion_config.scale_factor,
                n_nonlinear_layers_per_scaling_block=diffusion_config.n_nonlinear_layers_per_scaling_block,
                n_nonlinear_layers_per_mid_block=diffusion_config.n_nonlinear_layers_per_mid_block,
                transformer_dim=diffusion_config.transformer_dim,
